    ...
    def get(self, request, post_id, post_slug):
        ...
        return render(request, 'home/detail.html',
                      {'post': self.post_instance, 'comments': comments, 'form': self.form_class,
                       'reply_form': self.form_comment_reply, 'can_like': can_like})
...
class PostUpdateView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            new_post.save()
            messages.success(request, 'your message is updated successfully', 'success')
...
class PostAddReplyView(LoginRequiredMixin, View):
    ...
    def post(self, request, post_id, comment_id):
        ...
        if form.is_valid():
            ...
            reply.is_reply = True
            reply.save()
            messages.success(request, 'Your Ryply submitted successfully', 'success')
        return redirect('home:post_detail', post.id, post.slug)
